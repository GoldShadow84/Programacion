...
public class Tp3_Ej17 {
	...
	public static void main(String [] args) {
		...
		int [] arrA = {0,1,3,0,0,1,3,0,0,2,4,0,0,2,4,0,2,4,0,0}; // 2,4,3
		int [] arrB = {0,1,2,3,0,0,1,1,1,2,0,2,2,1,0,5,3,2,0,0};
	...
	public static void encontrar_secs(int [] arrA, int [] arrB) {
		...
		int inicio_carac_rep_arrB = 0;
			...
			//reemplazar(arrA, arrB, inicio_repetida_arrA, inicio_carac_rep_arrB);
			
			System.out.println("la secuencia más repetida empieza en la pos "+inicio_repetida_arrA);
	...
	public static int buscar_sec_rep(int [] arr, int inicio, int fin) {
	...
	public static void reemplazar(int [] arrA, int [] arrB, int in_rep_arrA, int in_car_rep_arrB) {
		
		//primero corrimiento a la derecha, luego reemplazar valor
